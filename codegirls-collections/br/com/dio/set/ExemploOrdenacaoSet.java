...
/*Dadas as seguintes informações sobre as minhas séries favoritos,
...
Série 3 = Nome: that '70s show, Gênero: cómedia, tempoEpisodio: 25
*/
...
public class ExemploOrdenacaoSet {
    public static void main(String[] args) {
        ...
        Set<Serie> minhasSeries5 = new TreeSet<>(new TempoEpisodio());
